...
- generate BEC averages using feature_id mean si values
...
### generate feature_id averages using SQL
...
```{sql sql_fid, connection=con,output.var="fid"}
...
### generate BEC averages from the feature_id average data


- generate BEC averages using pspl_init
- use SQL 
...
```{sql op_avg1,connection=con,output.var="op"}
