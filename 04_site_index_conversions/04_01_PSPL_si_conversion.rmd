...
# pre-delete
if(dbExistsTable(con,'pspl_site_index_bec')) {
  dbRemoveTable(con,'pspl_site_index_bec')
}
if(dbExistsTable(con,'pspl_site_index_fid')) {
  dbRemoveTable(con,'pspl_site_index_fid')
}
if(dbExistsTable(con,'pspl_site_index_op')) {
  dbRemoveTable(con,'pspl_site_index_op')
}

dbExecute(con,'alter table pspl_bec_site_index_post_convert rename to pspl_site_index_bec')
dbExecute(con,'alter table pspl_fid_site_index_post_convert rename to pspl_site_index_fid')
dbExecute(con,'alter table pspl_op_site_index_post_convert rename to pspl_site_index_op')
